class Docsettings(object):
    ...
    description = """
        ...
        """
    openapi_tags = [
        {"name": "index", "description": "The Web facing page with the **login screen**."},
        {"name": "create-user", "description": "**CREATE** new **Users** at /user."},
        {
            "name": "get-user",
        ...
        {"name": "create-course", "description": "**CREATE** a new **Course** at /course."},
        {
            "name": "get-course",
        ...
        },
        {
            ...
            "description": "**CREATE** a new **Course Section** at /create-course-section.",
        },
        {
            "name": "get-course-section",
            "description": "**GET** a Course Section by *ID* a specific **Course Section**.",
        },
        {
            "name": "delete-course-section",
            "description": "**DELETE** a Course Section by *ID* a specific **Course Section**.",
        },
    ]
    version = "0.0.1"
    ...
    license_info = {
        "name": "MIT",
        "url": "https://github.com/open-apprentice/ellie/blob/main/LICENSE",
    }
